...
func AllK8sConfigmaps(namespaceName string) utils.HttpResult {
	result := []v1.ConfigMap{}
...
func UpdateK8sConfigMap(data v1.ConfigMap) utils.HttpResult {
	kubeProvider := NewKubeProvider()
...
func DeleteK8sConfigmap(data v1.ConfigMap) utils.HttpResult {
	kubeProvider := NewKubeProvider()
	client := kubeProvider.ClientSet.CoreV1().ConfigMaps(data.Namespace)
...
func DescribeK8sConfigmap(namespace string, name string) utils.HttpResult {
...
func CreateK8sConfigMap(data v1.ConfigMap) utils.HttpResult {
	kubeProvider := NewKubeProvider()
	client := kubeProvider.ClientSet.CoreV1().ConfigMaps(data.Namespace)
