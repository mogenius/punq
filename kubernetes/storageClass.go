...
func AllStorageClasses() utils.HttpResult {
...
func UpdateK8sStorageClass(data storage.StorageClass) utils.HttpResult {
...
func DeleteK8sStorageClass(data storage.StorageClass) utils.HttpResult {
	kubeProvider := NewKubeProvider()
	client := kubeProvider.ClientSet.StorageV1().StorageClasses()
...
func DescribeK8sStorageClass(name string) utils.HttpResult {
...
func CreateK8sStorageClass(data storage.StorageClass) utils.HttpResult {
	kubeProvider := NewKubeProvider()
	client := kubeProvider.ClientSet.StorageV1().StorageClasses()
