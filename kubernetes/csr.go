...
func AllCertificateSigningRequests(namespaceName string) utils.HttpResult {
...
func UpdateK8sCertificateSigningRequest(data cmapi.CertificateRequest) utils.HttpResult {
...
func DeleteK8sCertificateSigningRequest(data cmapi.CertificateRequest) utils.HttpResult {
	kubeProvider := NewKubeProviderCertManager()
	client := kubeProvider.ClientSet.CertmanagerV1().CertificateRequests(data.Namespace)
...
func DescribeK8sCertificateSigningRequest(namespace string, name string) utils.HttpResult {
...
func CreateK8sCertificateSigningRequest(data cmapi.CertificateRequest) utils.HttpResult {
	kubeProvider := NewKubeProviderCertManager()
	client := kubeProvider.ClientSet.CertmanagerV1().CertificateRequests(data.Namespace)
